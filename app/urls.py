...
urlpatterns = [
    ...
    path('lost-item/archive/<int:pk>/', views.archive_lost_item, name='archive_lost_item'),
    ...
    path('update-accountable-person/', update_accountable_person, name='update_accountable_person'),
    ...
    path('export-property-pdf-par/', export_property_to_pdf_par, name='export_property_pdf_par'),
